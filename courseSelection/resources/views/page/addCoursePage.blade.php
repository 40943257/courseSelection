                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mb-3 mx-1 my-1">
                                ...
                                <select class="form-select" aria-label="Default select example" name="maxStudentNum"
                                    id="maxStudentNum">
                                    @for ($i = 1; $i <= 70; $i++)
                    ...
                    <div class="row">
                        <div class="col-md col-4 d-flex align-items-center justify-content-center">
                            <button class="btn btn-secondary dropdown-toggle mx-1 my-1" href="#" role="button"
                                id="Mon" data-bs-toggle="dropdown" aria-expanded="false">
                                星期一
                            </button>
                        ...
                        <div class="col-md col-4 d-flex align-items-center justify-content-center">
                            <button class="btn btn-secondary dropdown-toggle mx-1 my-1" href="#" role="button"
                                id="Tues" data-bs-toggle="dropdown" aria-expanded="false">
                                星期二
                            </button>
                        ...
                        <div class="col-md col-4 d-flex align-items-center justify-content-center">
                            <button class="btn btn-secondary dropdown-toggle mx-1 my-1" href="#" role="button"
                                id="Thrs" data-bs-toggle="dropdown" aria-expanded="false">
                                星期三
                            </button>
                        ...
                        <div class="col-md col d-flex align-items-center justify-content-center">
                            <button class="btn btn-secondary dropdown-toggle mx-1 my-1" href="#" role="button"
                                id="Wend" data-bs-toggle="dropdown" aria-expanded="false">
                                星期四
                            </button>
                        ...
                        <div class="col-md col d-flex align-items-center justify-content-center">
                            <button class="btn btn-secondary dropdown-toggle mx-1 my-1" href="#" role="button"
                                id="Fri" data-bs-toggle="dropdown" aria-expanded="false">
                                星期五
                            </button>
